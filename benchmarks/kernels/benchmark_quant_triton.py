        ...
        for static_scale in [True, False]:
            for dtype in ["half", "bfloat16", "float"]:
                ...
                triton.testing.Benchmark(
                    ...
                    plot_name=f"quant-hidden_size-{hidden_size}-dtype-{dtype}-static_scale-{static_scale}",
                    args={
...
def benchmark_quant(
    ...
    scale = torch.randn(1, 1, dtype=torch.float32, device=device) if static_scale else None
